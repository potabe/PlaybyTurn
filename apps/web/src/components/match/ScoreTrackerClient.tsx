...
export function ScoreTrackerClient({ initialMatch, session, players }: Props) {
  ...
  // â”€â”€ Players â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
  ...
  // â”€â”€ Score display â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
  ...
  // â”€â”€ Helper to calculate points â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
  ...
  // â”€â”€ Point handlers â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
  ...
  return (
    <div className="fixed inset-0 z-50 bg-background flex flex-col overflow-hidden">
      ...
      {/* â”€â”€ Score tap zones (Horizontal split top/bottom) â”€â”€ */}
            ...
            <AnimatePresence>
              {!isComplete && (
                <motion.button
                  ...
                  onClick={(e) => { e.stopPropagation(); handleSubtractPoint("team2"); }}
            ...
            <AnimatePresence>
              {!isComplete && (
                <motion.button
                  ...
                  exit={{ opacity: 0, scale: 0.5 }}
                  transition={{ type: "spring", damping: 18, stiffness: 380 }}
                  onClick={(e) => { e.stopPropagation(); handleSubtractPoint("team1"); }}
      ...
      {/* â”€â”€ Confirm end match overlay â”€â”€ */}
      <AnimatePresence>
        {showConfirm && (
          <motion.div
            initial={{ opacity: 0 }}
      ...
      {/* â”€â”€ Confirm reopen match overlay â”€â”€ */}
      <AnimatePresence>
        {showReopenConfirm && (
          <motion.div
            initial={{ opacity: 0 }}
...
// â”€â”€â”€ Edit Score Modal Component â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
