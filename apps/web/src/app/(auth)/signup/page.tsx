...
import { IconMail, IconLock, IconUser, IconEye, IconEyeOff, IconLoader2, IconBrandDiscord } from "@tabler/icons-react";
  ...
  async function handleEmailSignup(e: React.FormEvent) {
    ...
    if (result.error) {
      ...
      if (signInResult?.error) {
        setError("Account created, but failed to sign in automatically. Please try signing in.");
        setIsLoading(false);
      } else {
