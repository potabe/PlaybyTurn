...
import { IconMail, IconLock, IconEye, IconEyeOff, IconLoader2, IconUser, IconBrandDiscord } from "@tabler/icons-react";
...
export default function SignupPage() {
  ...
  async function handleGitHubSignup() {
    ...
    setError(null);
    try {
      await authClient.signIn.social({ provider: "github", callbackURL: `${window.location.origin}/auth-callback` });
    } catch (err: any) {
  ...
  async function handleDiscordSignup() {
    ...
    setError(null);
    try {
      await authClient.signIn.social({ provider: "discord", callbackURL: `${window.location.origin}/auth-callback` });
    } catch (err: any) {
